...
namespace WebApplication1.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IStoreDB, StoreDB>(new PerRequestLifetimeManager());
            container.RegisterType<IProducerService, ProducerService>(new PerRequestLifetimeManager());
